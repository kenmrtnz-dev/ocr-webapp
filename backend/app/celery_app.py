...
AI_ANALYZER_PROVIDER = str(os.getenv("AI_ANALYZER_PROVIDER", "openai")).strip().lower() or "openai"
AI_ANALYZER_MODEL = str(os.getenv("AI_ANALYZER_MODEL", "gpt-4o-mini")).strip() or "gpt-4o-mini"
